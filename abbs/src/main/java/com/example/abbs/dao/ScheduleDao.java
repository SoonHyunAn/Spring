...
public interface ScheduleDao {
	...
	@Select("select * from schedule where uid=#{uid} and sdate between #{startDay} and #{endDay}"
	...
	@Update("update schedule set sdate=#{sdate}, title=#{title} "
			+ " place=#{place}, startTime=#{startTime}, endTime=#{endTime}, "
			+ " isImportant=#{isImportant}, memo=#{memo} where sid=#{sid}")
